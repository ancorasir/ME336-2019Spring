...
Add following to your .bashrc file. Please replace "~" with you full path of you home directory, e.g. /home/your_usename/.
```sh
...
* After generated the panda_moveit_config package, edit panda_moveit_config/config/ros_controllers.yaml and delete all lines generated by moveit setup assistant and add the following lines:
```sh
controller_list:
 - name: "arm_controller"
