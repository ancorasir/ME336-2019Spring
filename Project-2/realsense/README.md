...
- #### Install from [Debian Package](https://realsense.intel.com/sdk-2/#install) - In that case treat yourself as a developer. Make sure you follow the instructions to also install librealsense2-dev package.
```bash
