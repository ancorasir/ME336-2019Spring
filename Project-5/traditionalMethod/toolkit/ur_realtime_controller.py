...
class URController:
    ...
    def movej(self,x, y, z, Rx, Ry, Rz, a, v):
        s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
        s.settimeout(10)
        s.connect((self.__robot_ip, self.__port))
        # time.sleep(0.05)
...
#     robotController.movej(home_tcp_position[0], home_tcp_position[1], home_tcp_position[2], home_tcp_position[3], home_tcp_position[4], home_tcp_position[5], 0.4, 0.6)
#     time.sleep(0.5)
